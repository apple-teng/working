# -*- encoding=utf8 -*-
__author__ = "fangjiu.cheng:ZJ1921-852 验证主机滚刷耗材寿命还有0%，app进入主界面时会弹出提示"

__case_theme__ = "概要:ZJ1921-852 验证主机滚刷耗材寿命还有0%，app进入主界面时会弹出提示"
"""
## 概要:ZJ1921-852 验证主机滚刷耗材寿命还有0%，app进入主界面时会弹出提示  
...
## 概要:ZJ1921-851 验证主机滚刷耗材寿命还有0%，app进入主界面时会弹出提示  
...
滚刷已到期，请及时更换
 忽略/查看  
'''
Accessories.check_rollbrach_exhaust_sp_window()
...
告警栏有常驻提示  
'''
Accessories.check_rollbrach_esident_prompt()
...
Accessories.into_rollbrach_esident_prompt()
''''    
**期望结果**  
APP 跳转到耗材详情页；
'''
Accessories.check_rollbrach_exhaust_show()
Accessories.reset_sidebrush()
Accessories.check_reset_rollbrach()
...
返回APP主界面，告警栏提示消失
'''
if Accessories.check_rollbrach_esident_prompt() == "存在":

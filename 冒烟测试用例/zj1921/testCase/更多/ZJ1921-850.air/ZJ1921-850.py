# -*- encoding=utf8 -*-
__author__ = "fangjiu.cheng:ZJ1921-850 验证主机滤芯耗材寿命还有0%，app进入主界面时会弹出提示"

__case_theme__ = "概要:ZJ1921-850 验证主机滤芯耗材寿命还有0%，app进入主界面时会弹出提示"
"""
## 概要:ZJ1921-850 验证主机滤芯耗材寿命还有0%，app进入主界面时会弹出提示  
...
## 概要:ZJ1921-851 验证主机滤芯滤芯耗材寿命还有0%，app进入主界面时会弹出提示  
...
滤芯已到期，请及时更换
 忽略/查看  
'''
Accessories.check_hepa_exhaust_sp_window()
...
告警栏有常驻提示  
'''
Accessories.check_hepa_esident_prompt()
...
Accessories.into_hepa_esident_prompt()
''''    
**期望结果**  
APP 跳转到耗材详情页；
'''
Accessories.check_hepa_exhaust_show()
Accessories.reset_hepa()
Accessories.check_reset_hepa()
...
返回APP主界面，告警栏提示消失
'''
if Accessories.check_hepa_esident_prompt() == "存在":
